...
export function Hero() {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center relative px-4 md:px-24 perspective-[1000px]">
      ...
      >
        <Link href="https://www.linkedin.com/in/athaya-fatih-aziz-756bb7371/" target="_blank" className="hover:text-foreground transition-colors" aria-label="LinkedIn">
        ...
        <Link href="https://github.com/freshlyavocado" target="_blank" className="hover:text-foreground transition-colors" aria-label="GitHub">
